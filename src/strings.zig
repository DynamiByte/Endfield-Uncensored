...
pub const cli = struct {
    ...
    pub const parse_missing_debug_value = "Missing value for --debug. Use one or more values, like: --debug boxes or --debug autoscroll";
    pub const parse_invalid_debug_value = "Invalid value for --debug. Supported values: boxes/b, autoscroll/as";
